...
ANSA_ANALYSIS_URL = env("ANSA_EXTRACTION_SERVICE", "http://aiservices03.ansa.priv:8888/caj/getanalysis/")
ANSA_TRANSLATION_URL = env("ANSA_TRANSLATION_URL", "")
ANSA_TRANSLATION_KEY = env("ANSA_TRANSLATION_KEY", "")
...
PUBLISH_ASSOCIATED_ITEMS = bool(strtobool(env("PUBLISH_ASSOCIATED_ITEMS", "true")))
